...
const Search = () => {
  ...
  useEffect(() => {
    ...
    const seracTermFromUrl = urlParams.get("searchTerm");
    const sortFromUrl = urlParams.get("sort");
    const categoryFromUrl = urlParams.get("category");
    if (seracTermFromUrl || sortFromUrl) {
      setSidebarData({
        ...sidebarData,
        searchTerm: seracTermFromUrl,
        sort: sortFromUrl,
  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div className="p-7 border-b md:min-h-screen md:border-r border-gray-500">
